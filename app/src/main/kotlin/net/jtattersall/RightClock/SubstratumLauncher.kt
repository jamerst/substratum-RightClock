...
package net.jtattersall.RightClock
...
import net.jtattersall.RightClock.AdvancedConstants.ORGANIZATION_THEME_SYSTEMS
import net.jtattersall.RightClock.AdvancedConstants.OTHER_THEME_SYSTEMS
import net.jtattersall.RightClock.AdvancedConstants.SHOW_DIALOG_REPEATEDLY
import net.jtattersall.RightClock.AdvancedConstants.SHOW_LAUNCH_DIALOG
import net.jtattersall.RightClock.ThemeFunctions.checkApprovedSignature
import net.jtattersall.RightClock.ThemeFunctions.getSelfSignature
import net.jtattersall.RightClock.ThemeFunctions.getSelfVerifiedPirateTools
import net.jtattersall.RightClock.ThemeFunctions.isCallingPackageAllowed
